    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        ...
        <table class="table">
          <tr>
            <td>
              <a href="{{ "/mypage/" . $post->user()->id()->value()  }}" style="color:#6f6152"><img class="rounded-full" style="border: 3px solid" src="{{ asset('/images/' . $post->user()->profile()->imagePath()->value())}}" width="70" height="70" align="right">{{ $post->user()->name()->value() }}</a><br>
